...
void DemoIntroduction(void)
{
    ...
    switch(DemoIntroState)
    {
        case 0:
			...
			oledPutROMString((ROM_STRING)"        SNAKE        ",3,0);
        ...
        case 6:
            ...
            oledPutROMString((ROM_STRING)"     SNAKE  MENU   ",0,0);
...
/*			FillDisplay(0xFF);*/
			...
			oledPutString(buffer,3,0);

			sprintf(buffer, "   BEST SCORE : %d", record);
			oledPutString(buffer,0,0);			
